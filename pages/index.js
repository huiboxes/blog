  ...
  return (
    <>
      ...
      <Row className="comm-main" type="flex" justify="center">
        <Col className="comm-frame" xs={24} sm={24} md={16} lg={14} xl={12}>
          <List
            header={<div>最近更新</div>}
            itemLayout="vertical"
            dataSource={mylist}
            renderItem={item => (
              <List.Item>
                ...
                <div className="list-icon">
                  <span><ClockCircleOutlined />2020/5/6</span>
                  <span><EyeOutlined />30000人</span>
                </div>
        ...
        <Col xs={0} sm={0} md={7} lg={5} xl={4} className="comm-main-right">
          <Author />
          <Advert />
        </Col>
      </Row>
